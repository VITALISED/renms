...
{
    typedef void (*Create)(
        cTkLinearMemoryPool *thiscall, void *lpAlloc, size_t liBufferSize, unsigned int liBufferAlignment);
    typedef void (*Malloc)(cTkLinearMemoryPool *thiscall, int liSize, int liAlignment, int *lpiAllocatedSize);

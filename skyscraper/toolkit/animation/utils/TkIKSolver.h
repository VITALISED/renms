...
class cTkIKConstraint
{
	...
	virtual void PreAdditive(cTkIKFullBody*, const cTkMatrix34*, const cTkMatrix34*, const cTkEulerVector*, const cTkEulerVector*);
	virtual void PostAnim(cTkIKFullBody*, cTkMatrix34*, AnimTransform*);
	virtual void PreSolve(cTkIKFullBody*, const cTkMatrix34*, const cTkMatrix34*, const cTkEulerVector*, const cTkEulerVector*);
	virtual void GetNumRows(int*, int*);
	virtual void BuildRows(cTkJacobianRow*, cTkJacobianRow*, const cTkIKFullBody*, const cTkMatrix34*, const cTkEulerVector*);

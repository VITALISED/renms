...
cTkPhysRelMat34 *cTkEngineUtils::ComputePhysRelMatFromNode(cTkPhysRelMat34 *result, TkHandle lHandle)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("40 53 48 83 EC ? 0F 28 05 ? ? ? ? 4C 8D 44 24 30"))(
        result, lHandle);
}
...
void cTkEngineUtils::GetNodeChildOBBs(TkHandle lNode, cTkVector<cTkAABB> *lAABBGroupOut, int liNodeType)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan(
...
TkHandle *cTkEngineUtils::AddNodesStep(TkHandle *result, TkAddNodesHandle *lHandle, int liMaxNumNodesToAdd)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("48 89 5C 24 08 57 48 83 EC ? 48 8B F9 48 8B DA 8B 4A 40"))(
        result, lHandle, liMaxNumNodesToAdd);
}
    ...
    std::function<bool(TkHandle)> *result, TkHandle lNode, uint32_t luNameHash, int liType)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("40 53 48 83 EC ? 48 8B D9 C7 01 ? ? ? ? 45 8B D1"))(
        result, lNode, luNameHash, liType);
}
    ...
    std::function<bool(TkHandle)> *result, TkHandle lNode, const char *lpacName, int liType)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("4C 89 44 24 18 53 48 81 EC ? ? ? ? 45 8B D1"))(
        result, lNode, lpacName, liType);
}
...
TkHandle *cTkEngineUtils::GetGroupNode(TkHandle *result, TkHandle lNode)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("48 89 5C 24 08 57 48 83 EC ? 8B DA 48 8B F9 90"))(
        result, lNode);
}
...
bool cTkEngineUtils::GetMatricesFromNode(TkHandle lHandle, cTkMatrix34 *lAbsoluteMatrix, cTkMatrix34 *lRelativeMatrix)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("48 83 EC ? 49 8B C0 48 85 D2"))(
        lHandle, lAbsoluteMatrix, lRelativeMatrix);
}
...
cTkSeed *cTkEngineUtils::GetSeedFromNode(cTkSeed *result, TkHandle lNode)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("48 89 5C 24 08 57 48 83 EC ? 48 8B F9 48 8D 4C 24 70"))(
        result, lNode);
}
...
bool cTkEngineUtils::IsNodeImposter(TkHandle lNode)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("40 53 48 81 EC ? ? ? ? 8B D9"))(lNode);
}
...
bool cTkEngineUtils::ReadModelFileName(TkHandle lModelNode, cTkFixedString<128, char> *lFilenameOut)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("48 89 5C 24 08 57 48 83 EC ? 48 8B DA E8 ? ? ? ? 33 FF"))(
        lModelNode, lFilenameOut);
}
...
void cTkEngineUtils::RequestTexturesAlwaysResident(TkHandle lBaseNode, bool lbValue)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("48 83 EC ? 48 8D 05 ? ? ? ? 88 54 24 28"))(
        lBaseNode, lbValue);
}
...
void cTkEngineUtils::SetNodeActiveRecursive(TkHandle lHandle, bool lbActive)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC F7 C1 ? ? ? ?"))(
        lHandle, lbActive);
}
...
void cTkEngineUtils::SetSceneNetworkId(TkHandle lNode, const char *lId, uint32_t lIndex, bool lbIncludeAttachments)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("40 53 55 57 48 83 EC ? 0F B6 02"))(
        lNode, lId, lIndex, lbIncludeAttachments);
}

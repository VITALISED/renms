...
class cGcUserSettings
{
  public:
    ...
    uint64_t mu64LastContentHash1;
    uint64_t mu64LastContentHash2;
    bool mbContentHashesValid;
    robin_hood::detail::Table<
        false, 80, cTkFixedString<128, char>, void, robin_hood::hash<cTkFixedString<128, char>, void>,

...
cGcSolarSystemQuery::cGcSolarSystemQuery() : mSystemAttributes()
{
    ...
    reinterpret_cast<fn_type>(
        renms::SignatureScan("48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 48 89 7C 24 20 41 54 41 56 41 57 48 83 "
...
void cGcSolarSystemQuery::Run(uint64_t lUA, cGcSolarSystemQuery::Type leType, bool lbGenerateObjectLists)
{
    ...
    return reinterpret_cast<fn_type>(renms::SignatureScan("40 53 57 41 54 41 55 41 56 41 57 48 83 EC ? 4C 8B C2"))(
        this, lUA, leType, lbGenerateObjectLists);
}

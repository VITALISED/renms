...
{
  public:
    virtual ~cGcApplicationSmokeTestState();
    ...
    // TODO: cTkAssertData type stuff
    void AssertCallback(cTkAssertData *lAssertData, bool *lpbIgnoreFlag, bool *lpbBreakEnabled);

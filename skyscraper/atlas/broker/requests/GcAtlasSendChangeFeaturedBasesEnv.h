/**
 * @file GcAtlasSendChangeFeaturedBasesEnv.h
...
class cGcAtlasSendChangeFeaturedBasesEnv : public cGcAtlasShared
{
  public:
    virtual ~cGcAtlasSendChangeFeaturedBasesEnv() final;

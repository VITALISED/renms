/**
 * @file GcAtlasSendRequestDiscoveryCategory.h
...
class cGcAtlasSendRequestDiscoveryCategory : public cGcAtlasShared
{
  public:
    virtual ~cGcAtlasSendRequestDiscoveryCategory() final;

...
RENMS_HOOK(
    cTkFileSystem__IsModded, "48 8B 01 48 85 C0 74 ? 0F B6 80 92 26 00 00", bool, (uint64_t thiscall) { return true; });

RENMS_HOOK(
    cGcApplicationGameModeSelectorState__RenderWarning,
    "48 8B C4 48 89 58 10 48 89 70 18 55 57 41 56 48 8D 6C 24 90 48 81 EC ? ? ? ? 48 8B 1D ? ? ? ?", void,

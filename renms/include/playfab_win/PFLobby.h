...
#include <include/playfab_win/PFEntityKey.h>
...
extern "C"
{
    ...
    /// <summary>
    /// The maximum number of concurrent properties which can be stored for the lobby and which aren't owned by any
    /// specific member.
    /// </summary>
...
#pragma pack(push, 8)
    ...
    enum class PFLobbyStateChangeType : uint32_t
    {
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyJoinLobbyCompletedStateChange" /> object
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyMemberAddedStateChange" /> object for
        /// more information.
        /// </remarks>
        MemberAdded = 2,
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyAddMemberCompletedStateChange" /> object
        /// for more information.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyMemberRemovedStateChange" /> object for
        /// more information.
        /// </remarks>
        MemberRemoved = 4,
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyLeaveLobbyCompletedStateChange" />
        /// object for more information.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyPostUpdateCompletedStateChange" />
        /// object for more information. <para> This operation completing only indicates whether the Lobby service has
        /// accepted the update or not. The title's local view of the Lobby state will not reflect this update until a
        /// <see cref="PFLobbyUpdatedStateChange" /> is provided to the title with the updated state.
        /// </para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyDisconnectingStateChange" /> object for
        /// more information.
        /// </remarks>
        Disconnecting = 9,
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyDisconnectedStateChange" /> object for
        /// more information.
        /// </remarks>
        Disconnected = 10,
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbyFindLobbiesCompletedStateChange" />
        /// object for more information.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The PFLobbyStateChange object should be cast to a <see cref="PFLobbySendInviteCompletedStateChange" />
        /// object for more information.
        /// </remarks>
        ...
        /// <summary>
        /// The operation started by a previous call to <see cref="PFMultiplayerCreateAndClaimServerLobby()" />
        /// completed.
        /// </summary>
        /// <remarks>
    ...
    enum class PFLobbyMemberRemovedReason : uint32_t
    {
        ...
        /// <summary>
        /// The remote user has been removed from the lobby. It is unspecified whether they left voluntarily or if they
        /// were forcibly removed by the owner.
        /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// Some migration policies trigger based on the lobby owner's connection status. A member is considered
    /// disconnected when their <see cref="PFLobbyMemberConnectionStatus" /> value changes from
    ...
    enum class PFLobbyOwnerMigrationPolicy : uint32_t
    {
        ...
        /// </summary>
        /// <remarks>
        /// If the current owner leaves, <see cref="PFLobbyGetOwner" /> will return a null owner until a new owner
        /// elects themselves.
        /// </remarks>
        None = 2,
    ...
    enum class PFLobbyAccessPolicy : uint32_t
    {
        ...
        /// </summary>
        /// <remarks>
        /// In some multiplayer social networks, friendship is a unidirectional relationship. One user may "follow"
        /// another or be their friend, but the same is not necessarily true in the reverse direction. This access
        /// policy only grants access when a bidirectional friendship exists. That is, the user querying for the lobby
        /// and the user in the lobby must both be friends with each other. <para> When querying for lobbies, users can
        /// opt into searching external multiplayer social networks for friendship relationships as well as the native
        /// PlayFab friends list. For example, a user could opt to check their Xbox Live friends list in addition to the
        /// PlayFab friends list. An external multiplayer social relationship can only be considered if both PlayFab
        /// users for this title have linked that mulitplayer social network to their PlayFab accounts.
        /// </para>
        /// </remarks>
        Friends = 1,
    ...
    enum class PFLobbyMemberConnectionStatus : uint32_t
    {
        ...
        /// </summary>
        /// <remarks>
        /// Lobby members that are not connected to the notification service may miss updates or see delayed updates
        /// while in this state.
        /// </remarks>
        NotConnected = 0,
        ...
        /// </summary>
        /// <remarks>
        /// Lobby members that are connected to the notification service will receive real-time updates indicating
    ...
    struct PFLobbyCreateConfiguration
    {
        ...
        /// lobby search results. <para> Search properties must be of the form string_keyN or number_keyN where "N" is a
        /// number between 1 and <c>PFLobbyMaxSearchPropertyCount</c>. e.g. string_key1, number_key14, etc. <para>
        /// </remarks>
    ...
    struct PFLobbyDataUpdate
    {
        ...
        /// <para>
        /// If this lobby is client-owned (the current owner is a title_player_account entity), the new owner must also
        /// be a title_player_account entity. If this lobby is server-owned (the current owner is a game_server entity),
        /// the new owner must also be a game_server entity.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// Only the properties specified in this list of keys will be updated. If the key doesn't exist yet, the
        /// property will be created. If the new property value is nullptr, the property will be deleted. Any existing
        /// properties omitted from this list will be left unmodified.
        /// </para>
        /// <para>
        ...
        /// Only the current lobby owner can update the lobby properties.
        /// <para>
        /// There may only be <c>PFLobbyMaxLobbyPropertyCount</c> concurrent lobby properties at any given time.
        /// Therefore, at most, twice that many unique properties can be specified in this update if half of those
        /// properties are being deleted.
        /// </para>
        /// <para>
    ...
    {
        /// <summary>
        /// A flag which includes the player's Steam friends list if their PlayFab account is linked to their Steam
        /// account.
        /// </summary>
        bool includeSteamFriends;

        /// <summary>
        /// A flag which includes the player's Facebook friends list if their PlayFab account is linked to their
        /// Facebook account.
        /// </summary>
        bool includeFacebookFriends;

        /// <summary>
        /// An Xbox Live token that, when provided, includes the player's Xbox Live friends list if their PlayFab
        /// account is linked to their Xbox Live account.
        /// </summary>
        /// <remarks>
        /// To retrieve this token, make a POST request to "https://playfabapi.com" with an empty request body using one
        /// of the GetTokenAndSignature APIs provided by Xbox Live. <para> GetTokenAndSignature APIs are provided
        /// natively as part of the Microsoft Game Core Development Kit (GDK). On all other platforms, these APIs are
        /// provided via the Xbox Authentication Library API (XAL).
        /// </para>
        /// </remarks>
    ...
    {
        /// <summary>
        /// A filter that, when provided, will constrain the lobby search operation to only those owned by the members
        /// of that player's various friend lists.
        /// </summary>
        /// <remarks>
        ...
        /// <para>
        /// Only the following operators are supported: "and" (logical and), "eq" (equal), "ne" (not equals), "ge"
        /// (greater than or equal), "gt" (greater than), "le" (less than or equal), and "lt" (less than).
        /// </para>
        /// <para>
        /// The left-hand side of each OData logical expression should be either a search property key (e.g.
        /// string_key1, number_key3, etc) or one of the predefined search keys (<c>PFLobbyMemberCountSearchKey</c>,
        ...
        /// </summary>
        /// <remarks>
        /// This string is formatted in an OData-like order-by syntax: a comma-separated list of search property keys
        /// with an optional specifier to sort in either ascending or descending order. <para> To specify ascending
        /// order, use the "asc" operator after the associated search property key. To specify descending order, use the
        /// "desc" operator after the associated search property key.
        /// </para>
        /// <para>
        /// Additionally, a special sorting moniker, distance, is supported to enable sorting by closest distance from
        /// some numeric value. For example, "distance{number_key10=5} asc" will sort the results so that lobbies who
        /// have their "number_key10" search property closer to the value "5" will return earlier in the search results.
        /// </para>
        /// <para>
    ...
    struct PFLobbySearchResult
    {
        ...
        /// <para>
        /// In some multiplayer social networks, friendship is a unidirectional relationship. One user may "follow"
        /// another or be their friend, but the same is not necessarily true in the reverse direction. Friends will only
        /// be returned in this search result when a bidirectional friendship exists. That is, the user querying for the
        /// lobby and the user in the lobby must both be friends with each other.
        /// </para>
        /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// PFLobbyStateChange structures are reported by <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> for
    /// the title to handle and then promptly pass back via the <see
    /// cref="PFMultiplayerFinishProcessingLobbyStateChanges()" /> method. <para> The <c>stateChangeType</c> field
    /// indicates which kind of state change occurred, and this base structure should then be cast to a more specific
    /// derived structure to retrieve additional event-specific information.
    /// </para>
    /// </remarks>
    ...
    /// <para>
    /// When this state change is provided by <see cref="PFMultiplayerStartProcessingLobbyStateChanges" /> the lobby
    /// will update to reflect the new member in the member list and the member's initial properties will become
    /// queryable.
    /// </para>
    /// </remarks>
    ...
    /// <para>
    /// When this state change is provided by <see cref="PFMultiplayerStartProcessingLobbyStateChanges" /> the lobby
    /// will update to remove this member from the member list and the member's properties will be emptied.
    /// </para>
    /// </remarks>
    ...
    /// Multiple updates may be provided by a single call to <see cref="PFMultiplayerStartProcessingLobbyStateChanges()"
    /// />. All state reflected by these updates will become available simultaneously when
    ...
    struct PFLobbyFindLobbiesCompletedStateChange : PFLobbyStateChange
    {
        ...
        /// </summary>
        /// <para>
        /// For title_player_account entity callers, at most <c>PFLobbyClientRequestedSearchResultCountUpperLimit</c>
        /// search results will ever be returned from a single <see cref="PFMultiplayerFindLobbies" /> operation. For
        /// game_server entity callers, at most 500 search results will ever be returned from a single <see
        /// cref="PFMultiplayerFindLobbies" /> operation.
        /// </para>
...
#pragma pack(pop)
    ...
    /// </para>
    /// <para>
    /// If this lobby object was created by calling <see cref="PFMultiplayerClaimServerLobby()" />, this method will
    /// return an error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a successful <see
    /// cref="PFLobbyClaimServerLobbyCompletedStateChange" />.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetLobbyId(PFLobbyHandle lobby, _Outptr_ const char **id) noexcept;
    ...
    /// <para>
    /// If this lobby object was created by calling <see cref="PFMultiplayerClaimServerLobby()" />, this method will
    /// return an error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a <see
    /// cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::maxMembersUpdated" /> set to
    ...
    /// </param>
    /// <returns>
    /// <c>S_OK</c> if the call succeeded or an error code otherwise. The human-readable form of the result can be
    /// retrieved via <see cref="PFMultiplayerGetErrorMessage()" />.
    /// </returns>
    PFMULTIPLAYER_API_ATTRIBUTES
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetMaxMemberCount(PFLobbyHandle lobby, _Out_ uint32_t *maxMemberCount) noexcept;
    ...
    /// If this lobby object was created by calling <see cref="PFMultiplayerJoinLobby()" />, this method will return an
    /// error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a
    /// <see cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::ownerUpdated" /> set to
    /// true. If joining the lobby succeeds, this field is guaranteed to be populated by the time
    /// PFMultiplayerStartProcessingLobbyStateChanges() provides a <see cref="PFLobbyJoinLobbyCompletedStateChange" />.
    /// <para>
    /// If this lobby object was created by calling <see cref="PFMultiplayerClaimServerLobby()" />, this method will
    /// return an error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a <see
    /// cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::ownerUpdated" /> set to true. If
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetOwner(PFLobbyHandle lobby, _Outptr_result_maybenull_ const PFEntityKey **owner) noexcept;
    ...
    /// If this lobby object was created by calling <see cref="PFMultiplayerJoinLobby()" />, this method will return an
    /// error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a
    /// <see cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::ownerMigrationPolicy" /> set
    /// to true. If joining the lobby succeeds, this field is guaranteed to be populated by the time
    /// PFMultiplayerStartProcessingLobbyStateChanges() provides a <see cref="PFLobbyJoinLobbyCompletedStateChange" />.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    ...
    PFLobbyGetOwnerMigrationPolicy(
        PFLobbyHandle lobby, _Out_ PFLobbyOwnerMigrationPolicy *ownerMigrationPolicy) noexcept;
    ...
    /// If this lobby object was created by calling <see cref="PFMultiplayerJoinLobby()" />, this method will return an
    /// error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a
    /// <see cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::accessPolicyUpdated" /> set
    /// to true. If joining the lobby succeeds, this field is guaranteed to be populated by the time
    /// PFMultiplayerStartProcessingLobbyStateChanges() provides a <see cref="PFLobbyJoinLobbyCompletedStateChange" />.
    /// <para>
    /// If this lobby object was created by calling <see cref="PFMultiplayerClaimServerLobby()" />, this method will
    /// return an error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a <see
    /// cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::accessPolicyUpdated" /> set to
    /// true. If claiming the lobby succeeds, this field is guaranteed to be populated by the time
    /// PFMultiplayerStartProcessingLobbyStateChanges() provides a
    /// <see cref="PFLobbyClaimServerLobbyCompletedStateChange" />.
    /// </para>
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetAccessPolicy(PFLobbyHandle lobby, _Out_ PFLobbyAccessPolicy *accessPolicy) noexcept;
    ...
    /// If this lobby object was created by calling <see cref="PFMultiplayerJoinLobby()" />, this method will return an
    /// error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a
    /// <see cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::membershipLockUpdated" />
    /// set to true. If joining the lobby succeeds, this field is guaranteed to be populated by the time
    /// PFMultiplayerStartProcessingLobbyStateChanges() provides a <see cref="PFLobbyJoinLobbyCompletedStateChange" />.
    /// <para>
    /// If this lobby object was created by calling <see cref="PFMultiplayerClaimServerLobby()" />, this method will
    /// return an error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a <see
    /// cref="PFLobbyUpdatedStateChange" /> with <see cref="PFLobbyUpdatedStateChange::membershipLockUpdated" /> set to
    /// true. If claiming the lobby succeeds, this field is guaranteed to be populated by the time
    /// PFMultiplayerStartProcessingLobbyStateChanges() provides a
    /// <see cref="PFLobbyClaimServerLobbyCompletedStateChange" />.
    /// </para>
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetMembershipLock(PFLobbyHandle lobby, _Out_ PFLobbyMembershipLock *lockState) noexcept;
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetConnectionString(PFLobbyHandle lobby, _Outptr_ const char **connectionString) noexcept;
    ...
    /// <para>
    /// If this lobby is server-owned, the owning game_server entity will <b>not</b> be returned in this list of
    /// members.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    ...
    PFMULTIPLAYER_API
    PFLobbyGetMembers(
        PFLobbyHandle lobby, _Out_ uint32_t *memberCount,
        _Outptr_result_buffer_(*memberCount) const PFEntityKey **members) noexcept;
    ...
    /// <see cref="PFLobbyMemberAddedStateChange" /> followed by a <see cref="PFLobbyAddMemberCompletedStateChange" />
    /// with the <see cref="PFLobbyAddMemberCompletedStateChange::result" /> field set to <c>S_OK</c>. Upon a failed
    /// completion, the title will be provided a <see cref="PFLobbyAddMemberCompletedStateChange" /> with the <see
    /// cref="PFLobbyAddMemberCompletedStateChange::result" /> field set to a failure hresult. <para> This method is
    /// used to add another local PlayFab entity to a pre-existing lobby object. Because the lobby object must have
    /// already been created either via a call to <see cref="PFMultiplayerCreateAndJoinLobby" /> or <see
    /// cref="PFMultiplayerJoinLobby" />, this method is primarily useful for multiple local user scenarios.
    /// </para>
    /// <para>
    /// This is an asynchronous operation. The member added via this method will not be reflected in the lists returned
    /// by <see cref="PFLobbyGetMembers" /> until the asynchronous operation successfully completes and a
    ...
    PFMULTIPLAYER_API
    PFLobbyAddMember(
        PFLobbyHandle lobby, const PFEntityKey *localUser,
        ...
        _In_reads_(memberPropertyCount) const char *const *memberPropertyValues, _In_opt_ void *asyncContext) noexcept;
    ...
    /// local owning entity who initiated this operation loses their ownership status while the operation is in
    /// progress, the operation will fail asynchronously.
    /// </para>
    /// <para>
    /// This is an asynchronous operation. The member removed via this method will not be removed from the lists
    /// returned by <see cref="PFLobbyGetMembers" /> until the asynchronous operation successfully completes and a
    ...
    /// A flag indicating whether <paramref name="targetMember" /> will be prevented from rejoining the lobby after
    /// being removed.
    /// </param>
    /// <param name="asyncContext">
    /// An optional, app-defined, pointer-sized context value that can be used to associate the completion state change
    ...
    PFLobbyForceRemoveMember(
        PFLobbyHandle lobby, const PFEntityKey *targetMember, bool preventRejoin, _In_opt_ void *asyncContext) noexcept;
    ...
    /// <see cref="PFLobbyLeaveLobbyCompletedStateChange" /> will be provided indicating that the operation has
    /// completed. <para> This method does not guarantee the leave will succeed. The operation may fail due to
    /// networking or service errors. If the leave attempt fails but is retriable, the library will continue to retry
    /// the leave operation. Otherwise, the local client will disconnect the requested local members from the lobby, but
    /// leave them as members. They will remain as disconnected members until they rejoin.
    /// </para>
    /// <para>
    ...
    /// </param>
    /// <param name="localUser">
    /// An optional value to indicate if a specific local user should leave the lobby. If this value is nullptr, all
    /// local users will leave the lobby.
    /// </param>
    /// <param name="asyncContext">
    /// An optional, app-defined, pointer-sized context value that can be used to associate the completion state change
    /// with this call.
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyLeave(PFLobbyHandle lobby, _In_opt_ const PFEntityKey *localUser, _In_opt_ void *asyncContext) noexcept;
    ...
    /// <see cref="PFMultiplayerClaimServerLobby()" /> or <see cref="PFMultiplayerJoinLobby()" />, this method will
    /// return no keys.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    ...
    PFLobbyGetSearchPropertyKeys(
        PFLobbyHandle lobby, _Out_ uint32_t *propertyCount,
        _Outptr_result_buffer_(*propertyCount) const char *const **keys) noexcept;
    ...
    PFLobbyGetSearchProperty(
        PFLobbyHandle lobby, _Null_terminated_ const char *key, _Outptr_result_maybenull_ const char **value) noexcept;
    ...
    PFLobbyGetMemberPropertyKeys(
        PFLobbyHandle lobby, const PFEntityKey *member, _Out_ uint32_t *propertyCount,
        _Outptr_result_buffer_(*propertyCount) const char *const **keys) noexcept;
    ...
    PFLobbyGetMemberProperty(
        PFLobbyHandle lobby, const PFEntityKey *member, _Null_terminated_ const char *key,
        _Outptr_result_maybenull_ const char **value) noexcept;
    ...
    /// about the lobby. <para> A local member which is still in the process of asynchronously joining the lobby, via a
    /// call to any of <see cref="PFMultiplayerCreateAndJoinLobby()" />, <see cref="PFMultiplayerJoinLobby()" />, or
    ...
    /// <c>PFLobbyMemberUpdateSummary::connectionStatusUpdated</c> field set to true. The
    /// <c>PFLobbyMemberUpdateSummary</c> will be provided to the title as a <c>memberUpdates</c> entry on a <see
    /// cref="PFLobbyUpdatedStateChange" /> struct via <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" />.
    /// </para>
    /// <para>
    /// When a user's connection status changes from <see cref="PFLobbyMemberConnectionStatus::Connected" /> to
    /// <see cref="PFLobbyMemberConnectionStatus::NotConnected" />, they may be experiencing connectivity issues - or
    /// their game may have crashed. The lobby owner can remove such users from the lobby via <see
    /// cref="PFLobbyForceRemoveMember()" />.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    /// The handle of the lobby.
    ...
    PFLobbyGetMemberConnectionStatus(
        PFLobbyHandle lobby, const PFEntityKey *member, _Out_ PFLobbyMemberConnectionStatus *connectionStatus) noexcept;
    ...
    /// <see cref="PFLobbyPostUpdateCompletedStateChange::result" /> field set to <c>S_OK</c>. Upon a failed completion,
    /// the title will be provided a <see cref="PFLobbyPostUpdateCompletedStateChange" /> with the <see
    /// cref="PFLobbyPostUpdateCompletedStateChange::result" /> field set to a failure. If applying the update would
    /// change the state of the lobby, the title will be provided a <see cref="PFLobbyUpdatedStateChange" /> sometime
    /// afterwards.
    /// <para>
    /// This operation completing successfully only indicates that the Lobby service has accepted the update. The
    /// title's local view of the Lobby state will not reflect this update until a <see cref="PFLobbyUpdatedStateChange"
    /// /> is provided to the title with the updated state.
    /// </para>
    /// <para>
    /// The <paramref name="lobbyUpdate" /> contains fields that can only be modified by the owner of the lobby. This
    /// method will return an error if one of those fields is specified and <paramref name="localUser" /> is not the
    /// owner of the lobby.
    /// </para>
    /// <para>
    /// If both a <paramref name="lobbyUpdate" /> and <paramref name="memberUpdate" /> are supplied to this method on
    /// behalf of a single entity, both updates will happen atomically.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    /// The handle of the lobby.
    ...
    /// An optional update to apply to the shared portion of the lobby on behalf of <paramref name="localUser" />. If
    /// this is not provided, <paramref name="memberUpdate" /> must be provided.
    /// </param>
    /// <param name="memberUpdate">
    /// An optional update to apply to the portion of the lobby owned by <paramref name="localUser" />. If this
    /// parameter is not provided, <paramref name="lobbyUpdate" /> must be provided.
    /// </param>
    /// <param name="asyncContext">
    /// An optional, app-defined, pointer-sized context value that can be used to associate the completion state change
    /// with this call.
    ...
    PFMULTIPLAYER_API
    PFLobbyPostUpdate(
        PFLobbyHandle lobby, const PFEntityKey *localUser, _In_opt_ const PFLobbyDataUpdate *lobbyUpdate,
        _In_opt_ const PFLobbyMemberDataUpdate *memberUpdate, _In_opt_ void *asyncContext) noexcept;
    ...
    /// <see cref="PFLobbySendInviteCompletedStateChange::result" /> field set to <c>S_OK</c>. Upon a failed completion,
    /// the title will be provided a <see cref="PFLobbySendInviteCompletedStateChange" /> with the <see
    /// cref="PFLobbySendInviteCompletedStateChange::result" /> field set to a failure. <para> The <paramref
    /// name="sender" /> must be a local user of this lobby which joined from this client.
    /// </para>
    /// </remarks>
    /// <param name="lobby">
    /// The handle of the lobby.
    ...
    PFMULTIPLAYER_API
    PFLobbySendInvite(
        PFLobbyHandle lobby, const PFEntityKey *sender, const PFEntityKey *invitee,
        _In_opt_ void *asyncContext) noexcept;
    ...
    /// </param>
    /// <returns>
    /// <c>S_OK</c> if retrieving the custom context succeeded or an error code otherwise. The human-readable form of
    /// the error code can be retrieved via <see cref="PFMultiplayerGetErrorMessage()" />.
    /// </returns>
    /// <seealso cref="PFLobbySetCustomContext" />
    PFMULTIPLAYER_API_ATTRIBUTES
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyGetCustomContext(PFLobbyHandle lobby, _Outptr_result_maybenull_ void **customContext) noexcept;
    ...
    /// </param>
    /// <returns>
    /// <c>S_OK</c> if configuring the custom context succeeded or an error code otherwise. The human-readable form of
    /// the error code can be retrieved via <see cref="PFMultiplayerGetErrorMessage()" />.
    /// </returns>
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbySetCustomContext(PFLobbyHandle lobby, _In_opt_ void *customContext) noexcept;
    ...
    /// <para>
    /// Lobby library state exposed by the library can change during this call, so you must be thread-safe in your use
    /// of it. For example, invoking PFMultiplayerStartProcessingLobbyStateChanges() on your UI thread at the same time
    /// a separate worker thread is looping through the list of lobby members returned by <see
    /// cref="PFLobbyGetMembers()" /> may result in crashes because PFMultiplayerStartProcessingLobbyStateChanges() can
    /// alter the memory associated with the member list. PFMultiplayerStartProcessingLobbyStateChanges() should be
    /// called frequently-- at least once per graphics frame. It's designed to execute and return quickly such that it
    /// can be called on your main UI thread with negligible impact. For best results, you should also minimize the time
    /// you spend handling state changes before calling PFMultiplayerFinishProcessingLobbyStateChanges().
    /// </para>
    /// <para>
    ...
    /// resources associated with a specific state change are guaranteed to stay valid until the state change is
    ...
    PFMultiplayerStartProcessingLobbyStateChanges(
        PFMultiplayerHandle handle, _Out_ uint32_t *stateChangeCount,
        _Outptr_result_buffer_(*stateChangeCount) const PFLobbyStateChange *const **stateChanges) noexcept;
    ...
    /// associated resources can be reclaimed. You may call PFMultiplayerFinishProcessingLobbyStateChanges() with any
    /// number of state changes. Each state change returned by PFMultiplayerStartProcessingLobbyStateChanges() must be
    /// returned to PFMultiplayerFinishProcessingLobbyStateChanges() exactly once, but may be returned out of order and
    /// may be interleaved with state changes from other calls to PFMultiplayerStartProcessingLobbyStateChanges().
    /// <para>
    ...
    /// by <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> that have now been handled by the title.
    /// </param>
    /// <param name="stateChanges">
    /// The array of changes previously returned by <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> that
    ...
    PFMultiplayerFinishProcessingLobbyStateChanges(
        ...
        _In_reads_(stateChangeCount) const PFLobbyStateChange *const *stateChanges) noexcept;
    ...
    PFMultiplayerCreateAndJoinLobby(
        PFMultiplayerHandle handle, const PFEntityKey *creator, const PFLobbyCreateConfiguration *createConfiguration,
        const PFLobbyJoinConfiguration *joinConfiguration, _In_opt_ void *asyncContext,
        _Outptr_opt_ PFLobbyHandle *lobby) noexcept;
    ...
    /// <see cref="PFLobbyJoinLobbyCompletedStateChange::result" /> field set to <c>S_OK</c>. Upon a failed completion,
    /// the title will be provided a <see cref="PFLobbyJoinLobbyCompletedStateChange" /> with the <see
    /// cref="PFLobbyJoinLobbyCompletedStateChange::result" /> field set to a failure.
    /// </remarks>
    /// <param name="handle">
    /// The handle of the PFMultiplayer API instance.
    /// </param>
    ...
    PFMultiplayerJoinLobby(
        PFMultiplayerHandle handle, const PFEntityKey *newMember, _Null_terminated_ const char *connectionString,
        const PFLobbyJoinConfiguration *configuration, _In_opt_ void *asyncContext,
        _Outptr_opt_ PFLobbyHandle *lobby) noexcept;

    /// <summary>
    /// Joins a lobby using an arrangement string provided by another service, such as matchmaking. If no one has joined
    /// the lobby yet, the lobby is initialized using the configuration parameters.
    /// </summary>
    /// <remarks>
    /// This is an asynchronous operation. Upon successful completion, the title will be provided a
    /// <see cref="PFLobbyMemberAddedStateChange" /> followed by a
    ...
    PFMultiplayerJoinArrangedLobby(
        PFMultiplayerHandle handle, const PFEntityKey *newMember, _Null_terminated_ const char *arrangementString,
        const PFLobbyArrangedJoinConfiguration *configuration, _In_opt_ void *asyncContext,
        _Outptr_opt_ PFLobbyHandle *lobby) noexcept;
    ...
    /// <see cref="PFLobbyFindLobbiesCompletedStateChange::result" /> field set to <c>S_OK</c>. Upon a failed
    /// completion, the title will be provided a <see cref="PFLobbyFindLobbiesCompletedStateChange" /> with the <see
    /// cref="PFLobbyFindLobbiesCompletedStateChange::result" /> field set to a failure.
    /// </remarks>
    /// <param name="handle">
    /// The handle of the PFMultiplayer API instance.
    /// </param>
    ...
    PFMultiplayerFindLobbies(
        PFMultiplayerHandle handle, const PFEntityKey *searchingEntity,
        const PFLobbySearchConfiguration *searchConfiguration, _In_opt_ void *asyncContext) noexcept;
    ...
    /// received, they will be provided via <see cref="PFLobbyInviteReceivedStateChange" /> structs. When the status of
    /// the invite listener changes, notifications will be provided via <see
    /// cref="PFLobbyInviteListenerStatusChangedStateChange" /> structs. <para> Only invites sent after the listener has
    /// been started will be received on this client. Invites sent while this listener is not active will not be queued.
    /// </para>
    /// <para>
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFMultiplayerStartListeningForLobbyInvites(PFMultiplayerHandle handle, const PFEntityKey *listeningEntity) noexcept;
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFMultiplayerStopListeningForLobbyInvites(PFMultiplayerHandle handle, const PFEntityKey *listeningEntity) noexcept;

    /// <summary>
    /// Retrieve the status of the entity's invite listener.
    /// </summary>
    /// <remarks>
    /// This value is used to understand the state of an entity's invite listener. If the invite listener encounters a
    /// fatal error, non-fatal error, or diagnostic change, the listener's status value will reflect it. <para> When the
    /// invite listener's status changes, a <see cref="PFLobbyInviteListenerStatusChangedStateChange" /> struct will be
    /// provided by <see cref="PFMultiplayerStartProcessingLobbyStateChanges" />. This method can then be called to
    ...
    PFMultiplayerGetLobbyInviteListenerStatus(
        PFMultiplayerHandle handle, const PFEntityKey *listeningEntity,
        _Out_ PFLobbyInviteListenerStatus *status) noexcept;
    ...
    /// <see cref="PFLobbyCreateAndClaimServerLobbyCompletedStateChange::result" /> field set to <c>S_OK</c>. Upon a
    /// failed completion, the title will be provided a <see cref="PFLobbyCreateAndClaimServerLobbyCompletedStateChange"
    /// /> with the <see cref="PFLobbyCreateAndClaimServerLobbyCompletedStateChange::result" /> field set to a failure.
    /// </para>
    /// </remarks>
    /// <param name="handle">
    /// The handle of the PFMultiplayer API instance.
    ...
    PFMultiplayerCreateAndClaimServerLobby(
        PFMultiplayerHandle handle, const PFEntityKey *server, const PFLobbyCreateConfiguration *createConfiguration,
    ...
    /// </para>
    /// <para>
    /// This operation is primarily intended to support game_server entities taking ownership of server-owned lobbies
    /// who's owners have disconnected or will disconnect. Typically, this is interesting for game_server entities who
    /// want to migrate ownership to another game_server entity or game_server entities who need to recover ownership of
    /// their own servers after some fatal failure which causes them to lose access to the lobby handle such as a crash.
    /// </para>
    /// <para>
    /// A game server may not claim ownership of a lobby which another another game_server entity is currently connected
    /// to.
    /// </para>
    /// </remarks>
    /// <param name="handle">
    ...
    PFMultiplayerClaimServerLobby(
        PFMultiplayerHandle handle, const PFEntityKey *server, _Null_terminated_ const char *lobbyId,
        _In_opt_ void *asyncContext, _Outptr_opt_ PFLobbyHandle *lobby) noexcept;
    ...
    /// <see cref="PFLobbyServerPostUpdateCompletedStateChange::result" /> field set to a failure. If applying the
    /// update would change the state of the lobby, the title will be provided a <see cref="PFLobbyUpdatedStateChange"
    /// /> sometime afterwards.
    /// </para>
    /// <para>
    /// This operation completing successfully only indicates that the Lobby service has accepted the update. The
    ...
    PFLobbyServerPostUpdate(
        PFLobbyHandle lobby, const PFLobbyDataUpdate *lobbyUpdate, _In_opt_ void *asyncContext) noexcept;
    ...
    /// To use this feature, you must define PFMULTIPLAYER_INCLUDE_SERVER_APIS before including PFLobby.h.
    /// <para>
    /// This method queues an asynchronous operation to delete the lobby on behalf of the game_server entity. On
    /// completion, a <see cref="PFLobbyServerDeleteLobbyCompletedStateChange" /> will be provided indicating that the
    /// operation has completed.
    /// </para>
    /// <para>
    /// This method does not guarantee the delete will succeed. The operation may fail due to networking or service
    /// errors. If the delete attempt fails but is retriable, the library will continue to retry the delete operation.
    /// Once the operation can no longer be retried, the operation will complete and a <see
    /// cref="PFLobbyServerDeleteLobbyCompletedStateChange" /> will be provided.
    /// </para>
    /// </remarks>
    /// <returns>
    /// <c>S_OK</c> if the call succeeded or an error code otherwise. The human-readable form of the error code can be
    ...
    HRESULT
    PFMULTIPLAYER_API
    PFLobbyServerDeleteLobby(PFLobbyHandle lobby, _In_opt_ void *asyncContext) noexcept;
#endif // PFMULTIPLAYER_INCLUDE_SERVER_APIS
